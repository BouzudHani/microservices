...
public class UrgenceCall {
    ...
    public EmergencyCall getEmergencyCall(){
        Ambulance ambulance = restTemplate.getForObject("http://hani:8072/getAmbulance",Ambulance.class);
        Driver driver1= restTemplate.getForObject("http://hani:8075/getDriver",Driver.class);
