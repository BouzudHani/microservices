...
public class UrgenceCall {
    ...
    public EmergencyCall getEmergencyCall(){
        Ambulance ambulance = restTemplate.getForObject("http://hani:8073/getAmbulance",Ambulance.class);
        Driver driver1= restTemplate.getForObject("http://hani:8076/getDriver",Driver.class);
